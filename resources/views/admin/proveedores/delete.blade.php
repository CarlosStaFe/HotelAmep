...
@section('content_header')
    <nav aria-label="breadcrumb" style="font-size: 14pt">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Eliminar Proveedor</li>
        </ol>
    </nav>
@stop
        ...
        <div class="col-md-12">
            <div class="card card-danger">
                <div class="card-header">
                    <h2 class="card-title"><b>Eliminar Proveedor</b></h2>
                </div>
                <div class="card-body" style="box-sizing: border-box; display: block;">
                    <div class="alert alert-warning">
                        Estás por eliminar este proveedor. Esta acción no se puede deshacer.
                    </div>
                    <div class="row">

...
return [
    ...
    */
    ...
    'logo' => '<b>Hotel AMEP</b>',
    'logo_img' => 'assets/img/pinardelrio.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Hotel Pinar del Rio',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'assets/img/pinardelrio.png',
            'alt' => 'Hotel Pinar del Rio',
            'class' => '',
            'width' => 120,
            'height' => 120,
        ],
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'submenu' => [
                        [
                            'text' => 'Listado Centros',
                            'url' => '/admin/ctrocostos/index',
                            'icon' => 'bi bi-card-list',
                            'classes' => 'bg-cyan text-white',

                        ],
                        [
                            'text' => 'Registrar Centro',
                            'url' => '/admin/ctrocostos/create',
                            'icon' => 'bi bi-inboxes',
                            'classes' => 'bg-cyan text-white',
                        ],
                    ],
                ...
                [
                    ...
                    'submenu' => [
                        [
                            'text' => 'Listado de Rubros',
                            'url' => '/admin/rubros/index',
                            'icon' => 'bi bi-list-check',
                            'classes' => 'bg-cyan text-white',
                        ],
                        [
                            'text' => 'Registrar Rubro',
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url' => '/admin/pasajeros/create',
                    'icon' => 'bi bi-person-vcard',
                    'classes' => 'bg-cyan text-white',
                ],
                [
                    'text' => 'Asignar Habitación',
                    'url' => '/admin/pasajeros/asignar-habitacion',
                    'icon' => 'bi bi-person-bounding-box',
                    'classes' => 'bg-cyan text-white',
                ],
                [
                    'text' => 'Listado de Pasajeros',
                    'url' => '/admin/pasajeros/index',
                    'icon' => 'bi bi-list-check',
                    'classes' => 'bg-cyan text-white',
                ],
            ],
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Cargar Consumo',
                    'url' => '/admin/comandas/create',
                    'icon' => 'bi bi-pencil-square',
                    'classes' => 'bg-cyan text-white',
                ],
                [
                    'text' => 'Listar Consumo',
                    'url' => '/admin/comandas/index',
                    'icon' => 'bi bi-list-check',
                    'classes' => 'bg-cyan text-white',
                ],
            ],
